...
# installed.
TCL_PREFIX='D:/DS_Projects/ats/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/DS_Projects/ats/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/DS_Projects/ats/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/DS_Projects/ats/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/DS_Projects/ats/venv\Library\lib tclstub86.lib'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='C:\ci\tk_1654036608655\work\tcl8.6.12\win\Release_AMD64_VC1916\tclstub86.lib'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='D:/DS_Projects/ats/venv\Library\lib\tclstub86.lib'
